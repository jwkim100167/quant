...
export default function USVerification() {
  ...
  return (
    <div>
      <div className="page-header">
        <div className="page-title">미국 신호 검증</div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        {scatterData.length === 0 ? (
          <div className="empty">주가 데이터 없음 (fetch-prices-fdr 실행 필요)</div>
        ) : (
          ...
          return (
            <div>
              ...
              <div style={{
                ...
                <strong>결론: </strong>
                {!simResult.hasBenchmark && '벤치마크 데이터가 없습니다.'}
